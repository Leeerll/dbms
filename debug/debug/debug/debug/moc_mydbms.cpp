...
void myDBMS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        myDBMS *_t = static_cast<myDBMS *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (myDBMS::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myDBMS::sendmessage)) {
                *result = 0;
                return;
            }
        }
        {
            typedef int (myDBMS::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myDBMS::posIsNos)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject myDBMS::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_myDBMS.data,
      qt_meta_data_myDBMS,  qt_static_metacall, nullptr, nullptr}
};
...
void *myDBMS::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_myDBMS.stringdata0))
        return static_cast<void*>(const_cast< myDBMS*>(this));
