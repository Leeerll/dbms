...
{
    QIcon icon_tadd;
    icon_tadd.addFile(tr("D:/dbms-master/FILE/res/add.png"));
    ui->tadd->setIcon(icon_tadd);

    QIcon icon_tdelete;
    icon_tdelete.addFile(tr("D:/dbms-master/FILE/res/delete.png"));
    ui->tdelete->setIcon(icon_tdelete);

    QIcon icon_tcorrect;
    icon_tcorrect.addFile(tr("D:/dbms-master/FILE/res/correct.png"));
    ui->tcorrect->setIcon(icon_tcorrect);

    QIcon icon_twrong;
    icon_twrong.addFile(tr("D:/dbms-master/FILE/res/wrong.png"));
    ui->twrong->setIcon(icon_twrong);

    QIcon icon_trefresh;
    icon_trefresh.addFile(tr("D:/dbms-master/FILE/res/refresh.png"));
