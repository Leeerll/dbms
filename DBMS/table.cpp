...
Table::Table(QString tableName,QString databasename){
    ...
    QFile f("D:\\dbms-master\\build-DBMS-Desktop_Qt_5_9_9_MSVC2015_32bit-Debug\\DBMS\\"+databasename+"\\table\\"+tableName+".txt");
    if(!f.exists())
    {
...
bool Table::readData(){
    //读取数据文件
    QFile f("D:\\dbms-master\\build-DBMS-Desktop_Qt_5_9_9_MSVC2015_32bit-Debug\\DBMS\\"+databasename+"\\data\\"+tableName+".txt");
    if(!f.open(QIODevice::ReadOnly|QIODevice::Text)){
...
bool Table::constraint()
{
    ...
    if(target)//是否结束操作
    {
        QFile fcache("D:\\dbms-master\\build-DBMS-Desktop_Qt_5_9_9_MSVC2015_32bit-Debug\\DBMS\\"+databasename+"\\data\\"+tableName+".txt");//清空
        fcache.open(QFile::WriteOnly|QFile::Truncate);
        fcache.close();
        QFile ffcache("D:\\dbms-master\\build-DBMS-Desktop_Qt_5_9_9_MSVC2015_32bit-Debug\\DBMS\\"+databasename+"\\data\\"+tableName+".txt");//还原
...
void Table::backups()
{
    QFile cache("D:\\dbms-master\\build-DBMS-Desktop_Qt_5_9_9_MSVC2015_32bit-Debug\\DBMS\\"+databasename+"\\data\\"+tableName+".txt");//从缓存文件中获取之前的语句内容并还原
